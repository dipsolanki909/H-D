  ...
  const contactInfo = [
    {
      icon: <FiMail />,
      title: 'Email',
      details: 'd.and.hcreatives101@gmail.com',
      description: 'We reply within 24 hours',
    },
    {
      icon: <FiPhone />,
      title: 'Phone',
      details: '9904357160 / 7048882596',
    ...
    <div className="contact-page">
        ...
        <div className="contact-container">
          ...
          <div className="quick-support">
            ...
            <div className="support-links">
              <button onClick={handleHelpCenter} className="support-link">
                <FiMessageSquare /> Visit Help Center
              </button>
              <button onClick={handleDocumentation} className="support-link">
                📚 Read Documentation
              </button>
              <button onClick={handleJoinCommunity} className="support-link">
                👥 Join Community
              </button>
            </div>
      ...
      <section className="social-section">
        ...
        <div className="social-links">
          <a href="https://x.com/dhcreatives101?s=11" target="_blank" rel="noopener noreferrer" className="social-link">
            𝕏 Twitter
          </a>
          <a href="https://www.facebook.com/share/18Srg5UP44/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="social-link">
            f Facebook
          </a>
          <a href="https://www.instagram.com/d_and_h_creatives?igsh=MXMwZDE2NmRsbmQ3cA==" target="_blank" rel="noopener noreferrer" className="social-link">
            📷 Instagram
          </a>
          <a href="https://youtube.com/@dhcreatives?si=i2lvia1b8K0CE4N4" target="_blank" rel="noopener noreferrer" className="social-link">
            ▶️ YouTube
          </a>
        </div>
      </section>
