...
export function Pricing() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'You can add extra storage at $5 per 100GB anytime. We\'ll notify you before you reach your limit with options to upgrade.',
    },
    {
    ...
    <div className="pricing-page">
      ...
      <section className="pricing-cards-section">
        <div className="pricing-cards-container">
          {plans.map((plan, idx) => {
            const features = Array.isArray(plan.features) ? plan.features : (plan.features || []).map(f=>({ name: f, included: true }));
